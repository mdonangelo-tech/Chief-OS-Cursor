    ...
    <section id="declutter" className="scroll-mt-6">
        ...
        {totalNew === 0 ? (
          ...
          <>
            <p className="text-foreground/90 text-sm">
              ...
              low-priority email{totalNew === 1 ? "" : "s"} into your Digest.
            </p>
            {topLine && (
            ...
            {totalOverdue > 0 && (
              <p className="text-muted-foreground text-xs mt-1">
                {totalOverdue.toLocaleString()} {totalOverdue === 1 ? "is" : "are"} past your archive window — a quick rules pass will keep it calm.
              </p>
            )}
          </>
        )}
      ...
      <div className="flex flex-wrap gap-3 mb-4">
        <Link
          ...
          className="rounded-xl bg-surface2/70 px-3 py-1.5 text-sm text-foreground hover:opacity-90"
        >
          Review declutter policy
        </Link>
